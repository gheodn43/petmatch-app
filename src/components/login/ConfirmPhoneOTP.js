...
export default function ConfirmPhoneOTP() {
    ...
    return (
        <div className="mb-10">
            ...
            <div className='flex justify-center align-items-center mt-3 mb-2'>
                <h5 className='font-bold  text-[15px] font-Roboto text-center text-[#666666] px-6'>
                    Chúng tôi đã gửi mã xác minh đến số điện thoại +8479*****54
                </h5>
            </div>
